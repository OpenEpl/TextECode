    ...
    public class TextECodeGenerator
    {
        ...
        private void GenerateProjectFile()
        {
            var projectModel = new ProjectModel()
            {
                ...
                ZipCode = ProjectConfig.ZipCode.NullIfEmpty(),
                Address = ProjectConfig.Address.NullIfEmpty(),
                TelephoneNumber = ProjectConfig.TelephoneNumber.NullIfEmpty(),
                FaxNumber = ProjectConfig.FaxNumber.NullIfEmpty(),
                Email = ProjectConfig.Email.NullIfEmpty(),
